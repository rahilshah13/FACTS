entry(aa, n, [aas], "raue schlackige Lava").
entry(aah, v, [aahed,aahing,aahs], "ausrufen in Erstaunen Freude oder Überraschung").
entry(aal, n, [aals], "ein ostindischer Strauch").
entry(aalii, n, [aaliis], "ein tropischer Baum").
Eintrag(aardvark, n, [aardvarks], "ein afrikanisches Säugetier").
eintrag(erdfuchs, n, [erdfüchse], "ein afrikanisches Säugetier").
Eintrag(aargh, interj, [], "verwendet, um Ekel auszudrücken").
Eintrag(aarrgh, interj, [], "aargh").
entry(aarrghh, interj, [], "aargh").
entry(aasvogel, n, [aasvogels], "ein Geier").
Eintrag(ab, n, [Bauchmuskel], "ein Bauchmuskel").
entry(aba, n, [abas], "ein ärmelloses Kleidungsstück, das von Arabern getragen wird").
entry(abaca, n, [abakas], "eine philippinische Pflanze").
entry(aback, adv, [], "nach hinten").
entry(abakus, n, [abakusse], "oder ABACIa Rechengerät").
entry(abaft, adv, [], "zum Heck hin").
entry(abaka, n, [abakas], "Abaka").
entry(abalone, n, [Abalonen], "ein essbares Schalentier").
Eintrag(abamp, n, [abamps], "Abampere").
entry(abampere, n, [Abampere], "eine Einheit des elektrischen Stroms").
Eintrag(verlassen, v, [verlassen,verlassend,verlässt], "zu verlassen oder vollständig aufzugeben").
entry(abapical, adj, [], "vom Apex weggerichtet").
Eintrag(abase, v, [abased, abasing, abases], "erniedrigen in Rang, Ansehen oder WertABASEDLY adv").
entry(abaser, n, [Abwiegler], "jemand, der erniedrigt").
entry(beschämen, v, [beschämt,beschämend,beschämt], "beschämt oder verlegen machen").
entry(abasia, n, [Abasien], "ein Defekt in der muskulären Koordination beim Gehen").
Eintrag(erniedrigend, präsens, [], "Partizip von erniedrigen").
entry(abate, v, [abated,abating,abates], "um das Maß oder die Intensität zu verringernABATABLE adj").
Eintrag(abater, n, [abaters], "jemand, der abmindert").
Eintrag(abatis, n, [abatises], "eine Barriere aus gefällten Bäumen").
entry(abator, n, [Abatoren], "jemand, der unrechtmäßig ein Erbe an sich reißt").
Eintrag(abattis, n, [abattises], "abatis").
entry(schlachthof, n, [schlachthöfe], "ein Schlachthaus").
Eintrag(abaxial, adj, [], "entfernt von der Achse gelegen").
entry(abaxile, adj, [], "abaxial").
Eintrag(abaya, n, [abayas], "ein langes, lockeres Gewand, das von arabischen Frauen getragen wird").
Eintrag(abba, n, [abbas], "Vater als Ehrentitel verwendet").
entry(abtei, n, [abteien], "das Amt eines Abtes").
entry(abbatial, adj, [], "einem Abt betreffend").
Eintrag(abbe, n, [abbes], "ein Abt").
entry(Äbtissin, n, [Äbtissinnen], "die weibliche Oberin eines Nonnenklosters").
eintrag(abtei, n, [abteien], "ein Kloster oder Konvent").
entry(abbot, n, [Äbte], "der Vorsteher eines Klosters").
entry(abbotcy, n, [abbotcies], "Abtswürde").
entry(abdizieren, v, [abdikierte, abtretend, abtretet], "förmlich aufgeben").
entry(abdomen, n, [abdomens], "oder ABDOMEN der Körperhohlraum, der die Eingeweide enthält").
Eintrag(abduzieren, v, [abduziert, abduzierend, abduziert], "entführen").
Eintrag(abducens, n, [abducentes], "ein Hirnnerv").
entry(abduzent, adj, [], "zum Abduzieren dienend").
entry(abducing, präsens, [], "Partizip von abduce").
Eintrag(entführen, v, [entführt,entführend,entführt], "von der ursprünglichen Position wegziehen").
Eintrag(entführte, n, [entführte], "eine Person, die entführt wurde").
Eintrag(entführer, n, [entführer], "oder ABDUCTORES ein abduzierender Muskel").
entry(querab, adv, [], "im rechten Winkel zum Kiel eines Schiffes").
Eintrag(abed, adv, [], "im Bett").
entry(betteln, adj, [], "begging").
entry(abele, n, [abeles], "ein europäischer Baum").
entry(abelia, n, [abelien], "ein asiatischer oder mexikanischer Strauch").
entry(abelsch, adj, [], "eine kommutative Gruppe in der Mathematik zu sein").
entry(abelmosk, n, [abelmosks], "eine tropische Pflanze").
Eintrag(aberrant, n, [aberrants], "ein Abweichler").
entry(anstiften, v, [stiftete_an,anstiftend,stiftet_an], "ermutigen und unterstützen").
entry(anstiftung, n, [anstiftungen], "der Akt des Anstiftens").
Eintrag(abettal, n, [abettals], "Anstiftung").
entry(abetted, vergangenheit, [], "Konjunktiv von anstiften").
entry(abetter, n, [abetters], "Anstifter").
Eintrag(anfeuernd, praesens, [], "Partizip von anfeuern").
Eintrag(anstifter, n, [anstifter], "jemand der anstiftet").
entry(unterbrechung, n, [unterbrechungen], "vorübergehende Inaktivität").
Eintrag("abeyancy", n, ["abeyancies"], "Aufschub").
entry(ruhend, adj, [], "gekennzeichnet durch ein Ruhen").
entry(abfarad, n, [abfarads], "eine Einheit der Kapazität").
Eintrag(abhenry, n, [abhenrys], "oder ABHENRIESeine Einheit der Induktivität").
entry(verabscheuen, v, [verabscheute,verabscheuend,verabscheut], "hassen").
eintrag(abhorrer, n, [abhorrers], "jemand, der verabscheut").
entry(beachtung, n, [beachtungen], "der Akt des Beachtens").
Eintrag(abide, v, [abode, abiding, abides], "akzeptieren ohne Einwand").
Eintrag(abider, n, [abiders], "einer der bleibt").
entry(abigail, n, [abigails], "eine Zofe").
Eintrag(fähigkeit, n, [fähigkeiten], "die Eigenschaft, etwas tun zu können").
Eintrag(abiosis, n, [abiosen], "Abwesenheit von LebenABIOTISCH adj").
Eintrag(abject, adj, [], "in einem niedrigen ZustandABJECTLY Adv versunken").
entry(abschwören, v, [abgeschworen,abschörend,abschwört], "unter Eid zu widerrufen").
entry(abbild, n, [abbilder], "einer, der entsagt").
entry(abtragen, v, [abgetragen,abtragend,abträgt], "durch Schneiden entfernen").
Eintrag(ablation, n, [ablationen], "chirurgische Entfernung eines Körperteils").
entry('Ablativ', n, ['Ablative'], "ein grammatikalischer Fall").
entry(ablator, n, [Ablatoren], "ein Element, das ablatiert").
entry(ablaut, n, [ablaute], "ein systematischer Wechsel der Stammvokale in den Verbformen").
entry(brandheiß, adj, [], "in Flammen stehend").
entry(fähig, adj, [], "FÄHIGER FÄHIGSThinreichend Macht, Geschick oder Ressourcen haben").
entry(fähig, n, [fähiger], "ein Kommunikationscodewort für den Buchstaben A").
entry(fähig, adj, [], "fähig zu ungehinderter Funktion").
entry(ablegate, n, [ablegaten], "ein päpstlicher Gesandter").
entry(ableismus, n, [ableismusse], "Vorurteil oder Diskriminierung gegen Menschen mit Behinderungen").
entry(ableist, n, [ableists], "jemand, der Ableismus praktiziert").
entry(fähiger, komparativ, [], "von fähig").
entry(fähigsten, superlative, [], "von fähig").
entry(ablings, adv, [], "ablins").
entry(ablins, adv, [], "vielleicht").
entry(abloom, adj, [], "blühend").
entry(abluens, n, [abluens], "ein Reinigungsmittel").
entry(ablush, adj, [], "errötend").
entry(abluted, adj, [], "gewaschen sauber").
entry(reinigung, n, [reinigungen], "eine Wäsche").
entry(ably, adv, [], "auf fähige Weise").
entry(abmho, n, [abmhos], "eine Einheit der elektrischen Leitfähigkeit").
entry(abnegieren, v, [abnegierte,abnegierend,abnegiert], "sich selbst verleugnen").
Eintrag(abnormal, n, [abnormale], "eine geistig eingeschränkte Person").
entry(an_bord, adv, [], "in ein Schiff, Zug oder Flugzeug hinein oder darauf").
entry(wohnstätte, v, [wohnstättete,wohnstättend,wohnstättet], "unheil verkünden").
Eintrag(abohm, n, [abohms], "eine Einheit des elektrischen Widerstands").
Eintrag(aboideau, n, [aboideaus], "oder ABOIDEAUX eine Art Deich").
entry(aboil, adj, [], "kochend").
entry(aboiteau, n, [aboiteaus], "oder ABOITEAUXaboideau").
entry(abschaffen, v, [abgeschafft,abschaffend,schafft_ab], "abschaffen").
entry(abolla, n, [abollae], "ein in antikem Rom getragener Mantel").
Eintrag(aboma, n, [abomas], "eine südamerikanische Schlange").
entry(abomasal, adj, [], "den Blättermagen betreffend").
entry(labmagen, n, [labmagen], "der vierte Magen eines Wiederkäuers").
entry(abomasus, n, [abomasi], "Labmagen").
entry(aboon, adv, [], "über").
entry(aboral, adj, [], "vom Mund entfernt gelegenABORAL adv").
entry(aborning, adv, [], "während der Geburt").
Eintrag(abortieren, v, [abortiert, abortierend, abortiert], "einen Fötus vorzeitig zur Welt bringen").
entry(aborter, n, [Abbrecher], "einer, der abbricht").
entry(abtreibung, n, [abtreibungen], "induziertes Ausstoßen eines nicht lebensfähigen Fötus").
entry(abortiv, adj, [], "scheitern zu gelingen").
entry(abortus, n, [Abortusse], "ein abgetriebener Fötus").
Eintrag(abought, vergangenheit, [], "Tempus von aby und abye").
Eintrag(aboulie, n, [aboulien], "abulieABULISCH adj").
entry(imÜberflussSein, v, [imÜberflussWar,imÜberflussSeiend,imÜberflussSind], "eine große Anzahl oder Menge haben").
entry(about, adv, [], "ungefähr").
entry(oben, n, [obens], "etwas, das oben an einem höheren Ort ist").
Eintrag(abrachia, n, [abrachias], "ein Mangel an Armen").
entry(abradant, n, [abradants], "ein Schleifmittel").
entry(schmirgeln, v, [geschmirgelt,schmirgelnd,schmirgelt], "durch Reibung abnutzen").
entry(abrader, n, [Schleifwerkzeuge], "ein Werkzeug zum Schleifen").
entry(abrasion, n, [Abnutzungen], "der Akt des Abscheuerns").
entry(schleifmittel, n, [schleifmittel], "ein schleifstoff").
entry(abreagieren, v, [abreagierte,abreagierend,abreagiert], "um unterdrückte Emotionen freizusetzen, indem man das ursprüngliche traumatische Erlebnis erneut durchlebt").
entry(abreast, adv, [], "nebeneinander").
entry(bunker, n, [bunker], "ein Bunker").
entry(abkuerzen, v, [abgekuerzt,abkuerzend,abkuerzt], "um die Laenge zu reduzieren").
entry(abridger, n, [Kürzer], "jemand, der kürzt").
Eintrag(abroach, adj, [], "in Bewegung").
Eintrag(ausland, adv, [], "außerhalb des eigenen Landes").
entry(aufheben, v, [aufgehoben,aufhebend,aufhebt], "durch autoritative Handlung abschaffen").
