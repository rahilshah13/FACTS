entry(aa, n, [aas], "lavi mbaya ya maganda").
entry(aah, k, [aahed,aahing,aahs], "kushangaa kwa furaha au mshangao").
entry(aal, n, [aals], "mmea wa Kihindi wa Mashariki").
ingizo(aalii, n, [aaliis], "mti wa kitropiki").
kiingilio(tembomajini, n, [matembomajini], "mnyama wa Afrika").
entry(mwamarara, n, [wamamarara], "mnyama wa Afrika").
entry(aargh, kihusishi, [], "inayotumika kueleza kuchukizwa").
ingia(aarrgh, kihisishi, [], "aargh").
entry(aarrghh, kihisishi, [], "aargh").
entry(aasvogel, n, [aasvogels], "mwewe").
kiingilio(ab, n, [abs], "misuli ya tumbo").
entry(aba, n, [abas], "vazi lisilo na mikono linalovaliwa na Waarabu").
entry(abaca, n, [abacas], "mmea wa Ufilipino").
entry(aback, kiv, [], "kuelekea nyuma").
entry(abakusi, n, [mabakusi], "au ABACIkifaa cha kuhesabu").
entry(abaft, kiv, [], "kuelekea sehemu ya nyuma ya meli").
kiingilio(abaka, n, [abakas], "abaca").
entry(samaki_wa_mwiba, n, [samaki_wa_mwiba], "samaki wa majini anayefaa kuliwa").
entry(abamp, n, [mabamp], "abampere").
ingizo(abampere, n, [abamperes], "kipimo cha sasa ya umeme").
entry(acha, k, [aliacha,anaacha,wataacha], "kuondoka au kutoa kabisa").
ingizo(abapical, kiv, [], "inayoelekezwa mbali na kilele").
ingizo(mshusha, v, [ilishushwa, inashusha, hushusha], "kuweka chini katika hadhi, heshima au thamaniKUSHUSHWA adv").
entry(abaser, n, [wadhilishaji], "mtu anayeshusha hadhi").
entry(abash, v, [abashed,abashing,abashes], "kuleta aibu au fedheha").
entry(abasia, n, [abasias], "upungufu katika uratibu wa misuli wakati wa kutembea").
kiingilio(abasing, ya sasa, [], "kitenzi kishirikishi cha abase").
entry(abate, v, [abated, abating, abates], "kupunguza kwa kiwango au nguvuABATABLE kiv").
entry(abater, n, [abaters], "mmoja ambaye huacha").
entry(abatis, n, [abatises], "kizuizi kilichotengenezwa na miti iliyokatwa").
entry(abator, n, [mnyakuzi], "yeye anayenyakua urithi kinyume cha sheria").
kiingilio(abattis, n, [abattises], "abatis").
entry(kiwanda_cha_makafani, n, [viwanda_cha_makafani], "mahali pa kuchinja wanyama").
entry(abaxial, adj, [], "iko mbali na mhimili").
entry(abaxile, kiv, [], "abaxial").
entry(abaya, n, [abaya], "joho refu na jepesi linalovaliwa na wanawake wa Kiarabu").
entry(abba, n, [abbas], "baba aliyetumika kama jina la heshima").
entry(abbacy, n, [abbacies], "cheo cha abate").
entry(abbatial, adj, [], "kuhusu abati").
kiingizo(abbe, n, [abbes], "abati").
entry(aba, n, [mama wa abasia], "kiongozi wa kike wa shirika la watawa wanawake").
entry(abbey, n, [abbeys], "monasteri au nyumba ya watawa").
entry(abati, n, [mabati], "mkuu wa monasteri").
entry(abbotcy, n, [abbotcies], "utawala wa abasia").
entry(aacha, v, [aliacha,anaacha,ataacha], "kuacha rasmi").
ingia(tumbo, n, [matumbo], "au TUMBOLAhifadhi ya mwili inayo vyombo vya ndani").
entry(abduce, v, [abduced,abducing,abduces], "kutekwa nyara").
kiingilio(abducens, n, [abducentes], "neva ya fahamu ya kichwa").
entry(abducent, adj, [], "zinafaa kwa kuteka").
kiingilio(abducing, hali_ya_sasa, [], "kirai cha abduce").
entry(teka, v, [kutekwa,utekaji,utekaji], "kuondoa kutoka nafasi ya awali").
entry(mtekaji, n, [watekaji], "mmoja ambaye ametekwa").
entry(mteka, n, [watekaji], "au ABDUCTORES misuli ya mvuto").
entry(abeam, kiv, [], "katika pembe ya kulia kwa mwambao wa meli").
entry(kitandani, kiv, [], "kitandani").
entry(abegging, adj, [], "kuomba").
entry(abele, n, [abeles], "mti wa Ulaya wa Mashariki").
entry(abelia, n, [abelias], "mmea wa shrub kutoka Asia au Mexico").
entry(abelian, adj, [], "kuwa kikundi kinachobadilishana katika hisabati").
entry(abelmosk, n, [abelmosks], "mmea wa kitropiki").
entry(aberrant, n, [aberrants], "mpotovu").
entry(abet, v, [abetted,abetting,abets], "kuchochea na kusaidia").
entry(uchochezi, n, [uchochezi], "kitendo cha kuchochea").
kiingilio(abettal, n, [abettals], "uchochezi").
kiingilio(abetted, iliyopita, [], "hali ya abet").
entry(abetter, n, [abetters], "mchochezi").
entry(abetting, hali_ya_sasa, [], "kitenzi hali ya sasa ya abet").
entry(msaidizi, n, [wasaidizi], "anayesaidia").
entry(angalizo, n, [angalizo], "kutofanya kazi kwa muda").
ingizo(abeyancy, n, [abeyancies], "mkwamo").
entry(abeyant, adj, [], "iliyotiwa alama ya kusubiri").
entry(abfarad, n, [abfarads], "kitengo cha uwezo wa kuhifadhi umeme").
entry(abhenry, n, [abhenrys], "au ABHENRIESkipimo cha unganisho").
entry(chukia, v, [chukiwa,kinyaa,wanachukia], "kuchukia").
entry(abhorrer, n, [abhorrers], "mtu anayechukia").
entry(utii, n, [utii], "kitendo cha kutii").
kiingilio(shikamakati, k, [shikama,kushikamakati,shikamakati], "kukubali bila pingamizi").
entry(abider, n, [abiders], "mtu anayeti").
entry(abigail, n, [abigail_za], "mjakazi wa bibi").
entry(uwezo, n, [uwezo], "hali ya uwezo wa kufanya jambo").
entry(abiosis, n, [abioses], "ukosefu wa uhai ABIOTIC kivumishi").
entry(abject, adj, [], "kuzama katika hali ya chiniABJECTLY adv").
entry(kana, v, [alikana,anakana,wanakana], "kukataa chini ya kiapo").
